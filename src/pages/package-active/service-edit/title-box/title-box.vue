      ...
      <div class="title-box" @click.stop>
        <div class="title-top">
          ...
          <div class="data-bottom">
            ...
            <textarea class="data-area" ref="txt" :class="{'long-text' : title === 'null'}" :focus="focus" :value="note" @change="submitTitle" :maxlength="maxLength" :placeholder="placeholder"></textarea>
          </div>
        </div>
  ...
  export default {
    ...
    methods: {
      showTitleBox(obj) {
        ...
        this.note = newObj.text || ''
        this.title = newObj.title || '标题'
        this.placeholder = newObj.placeholder || '请输入标题'
        this.type = newObj.type || 'name'
        this.maxLength = newObj.maxLength || 40
        this.showTitle = true
        setTimeout(() => {
          this.focus = true
        }, 150)
